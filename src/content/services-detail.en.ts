...
export const SERVICES_EN: ServiceDetail[] = [
  ...
  },
  {
    ...
    whatWeDeliver: [
      'Stability book (intact & damage)',
      'Damage stability simulation',
      'Structural FEA analysis report',
      'General Arrangement & detail drawings',
      'Class-society approval',
      'Hydrostatic & damage curves',
      'Tonnage & freeboard calculations',
    ],
    outcomes: [
  ...
  },
  {
    ...
    whatWeDeliver: [
      ...
      'Phase reviews & inspection logs',
      'Non-conformance reports',
      'Acceptance-trials protocol & results',
      'Final delivery report',
      'Offshore platforms & port infrastructure',
    ],
    outcomes: [
